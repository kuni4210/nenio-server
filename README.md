...
- 현재 백엔드 작업이 기능적으로 문제는 없으나 부족한 부분이 몇 가지 있습니다. API 문서의 Response 타입 보완, 주석으로 코드 설명, tdd 작성, 알림 기능 추가 및 트랜잭션 적용, 도메인 구매 및 SSL 적용 순으로 작업이 진행될 것 같습니다. 그 이후에도 유연하게 대응할 수 있는 준비를 하고 있습니다. 기획에 따라 2차 개발이 진행 될 것같습니다.
